...
\- `customer\_tier` - free / pro / enterprise

\- `account\_age\_days` - how long the customer has been active

\- `task\_name` - which task the agent is solving
...
\- `draft\_response` - a helpful reply string (task3 only)
